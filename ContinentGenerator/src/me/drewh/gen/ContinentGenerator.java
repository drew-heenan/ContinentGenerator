    ...
    public void generate() {
        ...
        for(int x = 0; x < this.size; x++)
            for(int y = 0; y < this.size; y++)
                img.setRGB(x, y, new Color((this.coastalTiles.contains(new Point(x, y)) || this.lakeShoreTiles.contains(new Point(x, y))) ? 255 : 0, (int)(255*heightMap[x][y]), 0).getRGB());
        try {
